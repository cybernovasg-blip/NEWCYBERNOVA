...
function triggerWin(type, prize) {
    ...
    setTimeout(() => {
        alert(`🏆 WINNER! You unlocked: ${prize}`);
        startFomoTimer();
...
function triggerNearMiss() {
    ...
    alert("🔥 SO CLOSE! The Merlion smells luck. WhatsApp for a VIP Retry!");
}
...
function startFomoTimer() {
    ...
    const itv = setInterval(() => {
        ...
        let sec = time % 60;
        banner.innerText = `⚠️ GOLD SPOT RESERVED: ${min}:${sec < 10 ? '0' : ''}${sec} LEFT!`;
        time--;
